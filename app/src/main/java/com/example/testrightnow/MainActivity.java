...
//View nav_header_view = navigationView.inflateHeaderView(R.layout.nav_header_main);
        ...
        //궁금한곳의 위도,경도,주소,사용자id,푸쉬알람을보내기위한 토큰을 서버로 전달합니다.
            ...
            public void onClick(View view) {
                new Thread() {
                    ...
                    public void run() {
                        ...
                        double camera_longitude = dou_longitude;    //궁금한곳의 위도경도
                        String latitude = Double.toString(camera_latitude);
                        String longtitude = Double.toString(camera_longitude);//서버로 보내기위해 String으로 변환
                        String userid = u_id;
                        String serverUrl = "http://27.96.134.241/htdocs/how.php";
                        String token =FirebaseInstanceId.getInstance().getToken();
                        final String address = getCurrentAddress(dou_latitude,dou_longitude);//궁금한곳의 위도,경도로 주소를 얻어옵니다.
                        try {
