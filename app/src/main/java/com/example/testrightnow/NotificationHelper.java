...
public class NotificationHelper {
     ...
     */
    //사진을 전송해야할때 실행되는 함수 입니다.(b가 1일때에 해당) 알람 터치시 사진을 보내야 하므로 CameraActivty class로 이동하게 되며 요청자의 토큰도 전달합니다.(사진을 보냈을 때 해당되는사람에게 알람이 가기위함입니다.)
    ...
    //사진이 도착했다는 알람이와서 클릭시 사진을 확인할수 있는 TalkActivity class로 이동하는 함수입니다.
